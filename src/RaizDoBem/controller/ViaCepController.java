...
/**
 * * Classe de controle para a API ViaCep. Esta classe é responsável por
 * gerenciar as operações relacionadas à consulta de informações de endereço com
 * base no CEP (Código de Endereçamento Postal) utilizando a API ViaCep. Ela
 * atua como uma camada intermediária entre a interface do usuário e a API,
