...
public class BeneficiarioDAO {
     ...
     *
     * @param idSelecionado O id do beneficiário que se deseja atualizar as informações.
     */
     ...
     * @param idSelecionado O id do beneficiário que se deseja excluir do sistema.
     * */
