...
public class Main {
    public static void main(String[] args) {
        ...
        CoordenadorInterno c1 = new CoordenadorInterno(1,"123.374", "643.934", "Hugo Costa", LocalDate.of(1994,9, 18), "hugo@email.com", "****",
        ...
        Beneficiario b1 = new Beneficiario(1,"123.122.444", "123.445.333",
                "Paulo Cavalcante", LocalDate.of(2010, 7,18), "Masculino", tipoBeneficiario1, e1);
        Beneficiario b2 = new Beneficiario(2,"235.122.244", "545.777.234",
        ...
        //Criando dentistas
        Dentista d1 = new Dentista(2, "123.321", "54.643", "Claudionor Costa",
                LocalDate.of(2000, 7,22),"Claudionor@email.com", "****", 1, "48385-34", "Ortodontia", true, "Coordenador", e3, e2);
        Dentista d2 = new Dentista(3, "344.787", "343.643.566", "Juliana Sousa",
