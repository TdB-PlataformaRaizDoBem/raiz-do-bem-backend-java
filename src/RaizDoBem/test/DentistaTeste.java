 ...
 * 1º Método - Criar um dentista, onde o usuário irá inserir os dados do dentista e o sistema irá criar um novo dentista com esses dados.
 * 2º Método - Listar todos os dentistas, onde o sistema irá exibir todos os dentistas cadastrados no sistema.
 * 3º Método - Buscar por CPF, onde o usuário irá inserir o CPF do dentista e o sistema irá exibir as informações do dentista correspondente a esse CPF, caso exista.
 * 4º Método - Atualizar, onde o usuário irá inserir o CPF do dentista que deseja atualizar, e o sistema irá solicitar as novas informações do dentista e atualizar os dados do dentista correspondente a esse CPF.
 * 5º Método - Excluir, onde o usuário irá inserir o CPF do dentista que deseja excluir, e o sistema irá remover o dentista correspondente a esse CPF do sistema.
